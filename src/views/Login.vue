<template>
    <div class="login-body">
      <div class="login-panel">
        <el-form
          ...
          ref="formDataRef"
        >
          <div v-if="opType == 0" class="login-title">注册</div>
          <div v-if="opType == 1" class="login-title">登录</div>
          <div v-if="opType == 2" class="login-title">重置密码</div>
          <!--input输入-->
          <el-form-item prop="email">
            ...
            >
              <template #prefix>
                ...
                <img src="../assets/mail.png" style="width:16px">
              </template>
            </el-input>
          </el-form-item>
          <!--登录密码-->
          ...
          <el-form-item v-if="opType == 1">
            <div class="rememberme-panel" style="margin-top: -14px;">
              <el-checkbox v-model="formData.rememberMe">
                记住我
              </el-checkbox>
              <a href="javascript:void(0)" class="a-link" @click="showPanel(2)" style="float: right;margin-top:2px"
                >忘记密码？</a
              >
            </div>
  ...
  .login-body {
    ...
    background: url("../assets/Frame_1.png");
    display: flex;
    .login-panel {
      width: 480px;
